...
?>
<form method="post" name="editar_dados" action="excluir_dados.php">
    ...
    <?php echo "<input type='text' name='caixa_aluno' value='$caixa_aluno' readonly><br><br>";?>
    <label for='nome'>Nome:</label>
    <?php echo "<input type='text' name='nome_aluno' value='$nome_aluno' readonly><br><br>";?>
    <label for='curso'>Curso:</label>
    <?php echo "<input id='curso' name='curso_aluno' value='$curso_aluno' readonly><br><br>";?>
